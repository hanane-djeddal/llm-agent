...
def main():
    ...
    for nb_row, row in enumerate(tqdm(dataset)):
        ...
        if (nb_row+1) % 150 == 0:
            ...
            results_file = results_path + "intr_testHagrid_"+tag+"_"+str(args.nb_rounds)+"rounds_"+str(args.nb_docs)+"docs.json"  # "agent_hagrid_3doc_2rounds.csv"
    ...
    results_file = results_path + "all_testHagrid_"+tag+"_"+str(args.nb_rounds)+"rounds_"+str(args.nb_docs)+"docs.json"  # "agent_hagrid_3doc_2rounds.csv"
    with open(results_file, "w") as writer:
        json.dump(results_df, writer)
